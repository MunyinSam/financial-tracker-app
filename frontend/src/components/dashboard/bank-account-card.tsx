...
import { BankAccountTransfer } from './actions/bank-account-transfer';
import { BankAccountHistory } from './actions/bank-account-history';
import { BankAccountClose } from './actions/back-account-close';
import { BankAccountEdit } from './actions/bank-account-edit';
...
export function BankAccountCard({
	...
	const handleTransferClick = () => {
		...
		setTimeout(() => setTransferOpen(true), 100); // Open transfer dialog with slight delay
	};

	const handleHistoryClick = () => {
		setOpen(false); // Close details dialog
		setTimeout(() => setHistoryOpen(true), 100); // Open transfer dialog with slight delay
	};
	...
	const handleCloseClick = () => {
		setOpen(false);
		setTimeout(() => setCloseOpen(true), 100);
	};
